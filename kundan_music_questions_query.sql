...
-- Q1 Write query to return the email, first_name, last_name, & Genere of all Rock music listeners.
-- Return your list orered alphabetically by email starting with 'a'.
...
-- Here best_selling_artist as CTE(Common table expression) which is temporary table.
